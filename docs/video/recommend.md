...
> https://api.bilibili.com/x/web-interface/index/ogv/rcmd
...
| 参数名        | 类型 | 内容           | 必要性 | 备注                                                      |
| ------------- | ---- | -------------- | ------ | --------------------------------------------------------- |
| request_cnt   | num  | 请求数量       | 非必要 | 默认 5                                                    |
| brush         | num  | 刷新次数       | 非必要 | 默认 0                                                    |
| fresh_type    | num  | 刷新类型       | 非必要 | 默认 0                                                    |
| season_type   | num  | 剧集类型       | 非必要 | 1：番剧<br />2：电影<br />3：纪录片<br />4：国创<br />5：电视剧 |
...
| 字段              | 类型  | 内容             | 备注                     |
| ----------------- | ----- | ---------------- | ------------------------ |
| source            | str   | 推荐来源         | 如"type_hot$u2a"         |
| season_id         | num   | 剧集ssid         |                          |
| season_type       | num   | 剧集类型         |                          |
| title             | str   | 标题             |                          |
| cover             | str   | 封面URL          |                          |
| goto              | str   | 跳转类型         | ogv_season               |
| id                | num   | 稿件id           |                          |
| epid              | num   | 剧集epid         |                          |
| pub_time          | str   | 发布时间         |                          |
| long_title        | str   | 长标题           |                          |
| trackid           | str   | 追踪id           |                          |
| ogv_creative_id   | num   | 创意id           |                          |
| owner             | obj   | 制作方信息       |                          |
| stat              | obj   | 统计信息         |                          |
| rcmd_reason       | obj   | 推荐理由         |                          |
...
`items`中的`rcmd_reason`对象：

| 字段         | 类型 | 内容     | 备注                  |
| ------------ | ---- | -------- | --------------------- |
| reason_type  | num  | 理由类型 | 1：标签推荐           |
| content      | str  | 理由内容 |                       |
        ...
        "items": [
            {
                ...
                "season_type": 4,
                "title": "在六千万光年以外，回望地球！",
                "cover": "https://i0.hdslb.com/bfs/bangumi/image/2a2d58308d51cca71aed5dc13aa1dc155fe519a4.png",
                "goto": "ogv_season",
                "id": 919839884,
                "epid": 789279,
                "pub_time": "2023-12-19 10:00:01",
                "long_title": "",
                "trackid": "web_ogv_0.router-ogv-2499245-fcvl4.1776324964459.375",
                "ogv_creative_id": 10000000000159672,
                "owner": {
                    "mid": 98627270,
                    "name": "哔哩哔哩国创",
