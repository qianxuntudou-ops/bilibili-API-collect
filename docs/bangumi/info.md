...
| ----------------- | ----- | ------------ | ---- |
| episode_id        | num   | 分集id       |      |
| like_animation    | array | 点赞动画     |      |
| related_up        | array | 相关UP主     |      |
| stat              | obj   | 统计信息     |      |
| up_like_img       | str   | UP点赞封面   |      |
...
| 参数名       | 类型 | 内容         | 必要性 | 备注                                                      |
| ------------ | ---- | ------------ | ------ | --------------------------------------------------------- |
| season_type  | num  | 剧集类型     | 必要   | 1：番剧<br />2：电影<br />3：纪录片<br />4：国创<br />5：电视剧 |
