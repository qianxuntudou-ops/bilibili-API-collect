...
| 参数名 | 类型 | 内容 | 必要性 | 备注 |
| ------ | ---- | ---- | ------ | ---- |
| need_bp | num | 是否需要B币信息 | 非必要 | 1: 是; 0: 否 |
| need_metal | num | 是否需要金属信息 | 非必要 | 1: 是; 0: 否 |
| platform | str | 平台 | 非必要 | pc |
| bp_with_decimal | num | B币是否带小数 | 非必要 | 未知 |
| ios_bp_afford_party | num | iOS B币承担方 | 非必要 | 未知 |
...
| gold | num | 金瓜子余额 | |
| bp | str | B币余额 | |
| need_use_new_bp | bool | 是否需要使用新版B币 | |
| ios_bp | num | iOS B币 | |
| common_bp | num | 通用B币 | |
| new_bp | str | 新版B币余额 | |
| bp_2_gold_amount | num | B币转金瓜子汇率 | |
...
| 字段 | 类型 | 内容 | 备注 |
| ---- | ---- | ---- | ---- |
| is_show | num | 是否显示 | 0: 否; 1: 是 |
| show_tips | str | 显示提示文字 | |
| goto_tips | str | 跳转提示文字 | |
| goto | str | 跳转链接 | |
| title | str | 标题 | |
...
| 参数名 | 类型 | 内容 | 必要性 | 备注 |
| ------ | ---- | ---- | ------ | ---- |
| context_type | num | 上下文类型 | 非必要 | 未知 |
| build | num | 构建号 | 非必要 | 未知 |
| platform | str | 平台 | 非必要 | pc |
| need_hamster | num | 是否需要金仓鼠信息 | 非必要 | 1: 是 |
| t | num | 时间戳 | 非必要 | 13位毫秒时间戳 |
...
| 字段 | 类型 | 内容 | 备注 |
| ---- | ---- | ---- | ---- |
| is_first_recharge | bool | 是否首次充值 | |
| openid | str | 支付标识 | |
| limit_amount | num | 充值限额 | |
| goods | array | 商品列表 | |
| common | obj | 公共信息 | |
| user | obj | 用户信息 | |
| channel | obj | 渠道信息 | |
| protocol_list | array | 协议列表 | |
| open_guild_buy_protocol | num | 公会购买协议开关 | 未知 |
| hamster_recharge_data | obj | 金仓鼠充值数据 | |
| protocol_default_open | num | 协议默认开启 | 未知 |
| protocol_ab_val | num | 协议AB测试值 | 未知 |
| panel_recommend_ab_val | num | 面板推荐AB测试值 | 未知 |
| panel_level_ab_val | num | 面板等级AB测试值 | 未知 |
| pay_hamster_version | num | 支付金仓鼠版本 | 未知 |
...
`data.hamster_recharge_data`对象:

| 字段 | 类型 | 内容 | 备注 |
| ---- | ---- | ---- | ---- |
| open | num | 是否开启 | 未知 |
| closed_reason | str | 关闭原因 | |
| fast_balance | num | 快速余额 | 未知 |
| rate | num | 汇率 | |
