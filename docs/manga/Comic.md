...
> https://manga.bilibili.com/twirp/comic.v1.Comic/HomeHot
...
| comic_id        | num   | 漫画id       |                          |
| title           | str   | 漫画标题     |                          |
| author          | array | 作者列表     | 每个元素为作者名称字符串 |
| vertical_cover  | str   | 竖版封面URL  |                          |
| is_finish       | num   | 是否完结     | 0：连载中<br />1：已完结 |
| last_ord        | num   | 最新话序号   |                          |
| last_short_title| str   | 最新话标题   |                          |
| styles          | array | 风格标签列表 |                          |
| total           | num   | 总话数       |                          |
| last_rank       | num   | 上周排名     |                          |
| last_ep         | num   | (?)          |                          |
    ...
    "data": [
        {
            ...
            "vertical_cover": "https://i0.hdslb.com/bfs/manga-static/1572f58dd448a1361350eb4079472d361a292181.jpg",
            "is_finish": 0,
            "last_ord": 128,
            "last_short_title": "108",
            "styles": [
                {
                    "id": 1002,
                    "name": "都市"
        ...
        },
        {
            ...
            "vertical_cover": "https://i0.hdslb.com/bfs/manga-static/d864e1f1041f55e703e24d7bb825e13994f22bab.jpg",
            "is_finish": 0,
            "last_ord": 186,
            "last_short_title": "186",
            "styles": [
                {
                    "id": 997,
                    "name": "古风"
...
> https://manga.bilibili.com/twirp/comic.v1.Comic/Recommend
...
| 字段               | 类型  | 内容             | 备注                     |
| ------------------ | ----- | ---------------- | ------------------------ |
| season_id          | num   | 漫画season_id    |                          |
| title              | str   | 漫画标题         |                          |
| horizontal_cover   | str   | 横版封面URL      |                          |
| square_cover       | str   | 方形封面URL      |                          |
| vertical_cover     | str   | 竖版封面URL      |                          |
| is_finish          | num   | 是否完结         | 0：连载中<br />1：已完结 |
| status             | num   | 状态             | 0：正常                  |
| last_ord           | num   | 最新话序号       |                          |
...
| discount_type      | num   | 折扣类型         |                          |
| allow_wait_free    | bool  | 允许等待免费     |                          |
| styles             | array | 风格标签         | 每个元素为标签名称        |
| tags               | array | 标签             | 每个元素为标签名称        |
| rank_info          | obj   | 排名信息         |                          |
| score              | num   | 评分             |                          |
| update_day         | num   | 更新星期         | 0表示不固定              |
| good_review        | num   | 好评数           |                          |
| search_num         | num   | 搜索量           |                          |
| author_name        | array | 作者名称列表     |                          |
| rec_tag_id         | num   | 推荐标签id       |                          |
| rec_tag            | str   | 推荐标签文字     |                          |
| rec_tag_type       | num   | 推荐标签类型     |                          |
| vertical_cover_info| obj   | 竖版封面信息     |                          |
    ...
    "data": [
        {
            "season_id": 26470,
            "title": "一拳超人",
            "horizontal_cover": "http://i0.hdslb.com/bfs/manga-static/098f9f01e59beecd77d14b0e2eee5ef4cb549d0b.jpg",
            "square_cover": "http://i0.hdslb.com/bfs/manga-static/52c014c5b2d6f076fcd2c4f73d0428d87f73ba12.jpg",
            "vertical_cover": "https://i0.hdslb.com/bfs/manga-static/accd35013c082cb622fb8749c86aec3bd4fb9253.jpg",
            "is_finish": 0,
            "status": 0,
            "last_ord": 291,
            "total": 298,
            "release_time": "",
            "last_short_title": "新·272",
            "ext": "",
            "recommend_reason": "",
            "discount_type": 0,
            "allow_wait_free": false,
...
> https://manga.bilibili.com/twirp/comic.v1.MainStation/Feed
        ...
        "list": [
            {
                "comic_id": 24855,
                "title": "镖人",
                "horizontal_cover": "http://i0.hdslb.com/bfs/manga-static/1e28b415c890f32bf71cd318953828f716c0a4c0.png",
                "is_finish": 0,
                "last_short_title": "第174话",
                "recommendation": "",
                "style": "武侠仙侠"
            },
            {
                "comic_id": 36091,
                "title": "变成克系触手怪后，她们更疯狂了!",
                "horizontal_cover": "https://i0.hdslb.com/bfs/manga-static/d38aff1c3058dd633e072754c9b5dd8536020852.png",
                "is_finish": 0,
                "last_short_title": "第60话",
                "recommendation": "兴奋就会变成触手怪的男主，不得不与各色美少女展开恋爱喜剧。",
                "style": "都市"
            }
        ]
    }
