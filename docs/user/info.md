...
| name_render     | 有效时：obj<br />无效时：null | 昵称渲染信息 | |
| is_senior_member | num | 是否为硬核会员 | 0: 否<br />1: 是 |
| rank            | num   | 用户权限等级 | 0: 未答题<br />5000: 0级<br />10000: 普通会员<br />20000: 字幕君<br />25000: VIP<br />30000: 真·职人<br />32000: 管理员 |
...
`card`中的`vip`中的`super_vip`对象：

| 字段 | 类型 | 内容 | 备注 |
| ---- | ---- | ---- | ---- |
| is_super_vip | bool | 是否为超级大会员 | |

`card`中的`vip`中的`avatar_icon`对象：
