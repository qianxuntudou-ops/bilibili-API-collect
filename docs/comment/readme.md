...
| mid_str       | str                             | 发送者mid          | 字串格式                                                     |
| oid_str       | str                             | 评论区对象id       | 字串格式                                                     |
...
| dynamic_id    | num                             | 关联动态id         |                                                              |
| dynamic_id_str | str                            | 关联动态id         | 字串格式                                                     |
| note_cvid_str | str                             | 关联笔记cvid       | 字串格式                                                     |
| track_info    | str                             | 追踪信息           | 未知                                                         |
