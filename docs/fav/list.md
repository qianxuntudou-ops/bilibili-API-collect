...
| ------------------ | ----- | ------------------ | -------------------------- |
| id                 | num   | 分组id             |                            |
| name               | str   | 分组名称           | 如"我创建的收藏夹"         |
| mediaListResponse  | obj   | 收藏夹列表响应     |                            |

`data`中的`mediaListResponse`对象：
...
`mediaListResponse`中的`list`数组中的对象：
...
| cover        | str   | 封面URL        |                          |
| upper        | obj   | 创建者信息     |                          |
| cover_type   | num   | 封面类型       | 0：无<br />2：视频封面   |
| intro        | str   | 简介           |                          |
| ctime        | num   | 创建时间       | 秒级时间戳               |
| mtime        | num   | 修改时间       | 秒级时间戳               |
| state        | num   | 状态           | 0：正常                  |
| fav_state    | num   | 收藏状态       |                          |
| media_count  | num   | 内容数量       |                          |
| is_top       | bool  | 是否置顶       |                          |
| play_switch  | num   | 播放开关       |                          |
| type         | num   | 类型           |                          |
                ...
                "list": [
                    {
                        ...
                        "attr": 20,
                        "title": "可乐零食沙发电视",
                        "cover": "http://i2.hdslb.com/bfs/archive/565711b5d2343737564fdaa9a5e23ec0bd5fa63f.jpg",
                        "upper": {
                            "mid": 8126584,
                            "name": "灬灬桃子灬阿狸灬灬",
                            "face": "http://i1.hdslb.com/bfs/face/06a07dad46ecb426e26e3340b3ae4e6f308066ea.jpg"
                        },
                        "cover_type": 2,
                        "intro": "",
                        "ctime": 1438922096,
...
> https://api.bilibili.com/x/v3/fav/resource/list4navigate
...
| link             | str   | 跳转链接     |                       |
| ctime            | num   | 创建时间     | 秒级时间戳            |
| pubtime          | num   | 发布时间     | 秒级时间戳            |
| fav_time         | num   | 收藏时间     | 秒级时间戳            |
| bv_id            | str   | 稿件bvid     |                       |
| bvid             | str   | 稿件bvid     |                       |
| season           | obj   | 剧集信息     | null：非剧集          |
| ogv              | obj   | OGV信息      | null：非OGV           |
| ugc              | obj   | UGC信息      |                       |
    ...
    "data": [
        {
            "id": 113729794478732,
            "type": 2,
            "title": "【闯关东】豆瓣9.3分！一代人的血泪移民史！万字精讲年代史诗巨作《闯关东》P1",
            "cover": "http://i2.hdslb.com/bfs/archive/565711b5d2343737564fdaa9a5e23ec0bd5fa63f.jpg",
            "intro": "《闯关东》主要讲述了从清末到九一八事变爆发前，主人公山东人朱开山一家的故事。",
            "page": 1,
            "duration": 2364,
            "upper": {
                "mid": 90445151,
                "name": "CC琦先生",
                "face": "https://i2.hdslb.com/bfs/face/23038d48dce93e37841aea17d382bee00b509e35.jpg",
                "jump_link": ""
            },
            "attr": 0,
            "cnt_info": {
            ...
            "link": "bilibili://video/113729794478732",
            "ctime": 1735379848,
            "pubtime": 1735379848,
            "fav_time": 1772788922,
            "bv_id": "BV17jCaYeEvo",
